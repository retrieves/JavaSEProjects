...
public class Test {
	public static void main(String[] args) {
		...
		MetrixGraph<String> graph = MetrixGraph.createGraph(GraphKind.DG, data, tail, head, null, null);
		graph.display();
		System.out.println("--------------------");
...
//******************************************************************************************************
		...
		MetrixGraph<String> graph3 = MetrixGraph.createGraph(GraphKind.UDG, data3, tail3, head3, null, null);
		graph3.display();
		System.out.println("--------------------");
...
//*********************************************************************************************************
		...
		MetrixGraph<String> graph4 = MetrixGraph.createGraph(GraphKind.UDG, data4, tail4, head4, null, null);
		graph4.display();
		System.out.println("--------------------");
		graph4.BFSTraverse();
...
//*********************************************************************************************************
		...
		MetrixGraph<String> graph5 = MetrixGraph.createGraph(GraphKind.UDG, data5, tail5, head5, null, null);
		graph5.display();
...
//*********************************************************************************************************
		...
		MetrixGraph<String> graph6 = MetrixGraph.createGraph(GraphKind.UDN, data6, tail6, head6, weight6,null);
		System.out.println("--------------------");
...
//*********************************************************************************************************
		...
		MetrixGraph<String> graph7 = MetrixGraph.createGraph(GraphKind.UDG, data7, tail7, head7, null,null);
		graph7.findArticul();
//*********************************************************************************************************
		// 测试Dijkstra算法求最短路径 
		...
		MetrixGraph<String> graph8 = MetrixGraph.createGraph(GraphKind.DN, data8, tail8, head8, weight8, null);
...
//*********************************************************************************************************
		...
		MetrixGraph<String> graph9 = MetrixGraph.createGraph(GraphKind.DN, data9, tail9, head9, weight9, null);
...
//*********************************************************************************************************	
		...
		MetrixGraph<String> graph10 = MetrixGraph.createGraph(GraphKind.DG, data10, tail10, head10, null,null);
...
//*********************************************************************************************************
		...
		MetrixGraph<String> graph11 = MetrixGraph.createGraph(GraphKind.DN, data11, tail11, head11, weight11,null);
