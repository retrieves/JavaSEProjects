...
public class UpdMaterialDialog extends JDialog implements ActionListener {
	...
	public UpdMaterialDialog(Stock stock) {
		this.stock = stock;
		sm = new StockModel();
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "confirm":
			...
			Stock stock =new Stock(this.stock.getId(),name, unit, supId);
			sm.updStock(stock);
			showMsg("Success");
			this.dispose();
			break;
